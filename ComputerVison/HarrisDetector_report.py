...
def HarrisDetector(src, gaus_filter_size = 3, gaus_sigma = 1, alpha = 0.04, threshold_rate = 0.01):
    ...
    cv2.imshow('20221234 - dst_x_Norm', dst_x_Norm)
    cv2.imshow('20221234 - dst_y_Norm', dst_y_Norm)
    cv2.waitKey()
    ...
    cv2.imshow('20221234 - IxIx', IxIx)
    cv2.imshow('20221234 - IyIy', IyIy)
    ...
    cv2.imshow('20221234 - G_IxIx', G_IxIx)
    cv2.imshow('20221234 - G_IyIy', G_IyIy)
    ...
    cv2.imshow('20221234 - har before threshold', G_dst_har_Norm)
    ...
    cv2.imshow('20221234 - har after threshold', G_dst_har_thresh_Norm)
...
def main():
    ...
    cv2.imshow('20221234 - interest points', interest_points)
    cv2.imshow('20221234 - harris_img', harris_img)
    cv2.waitKey()
